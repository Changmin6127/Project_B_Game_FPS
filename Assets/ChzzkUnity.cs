...
public class ChzzkUnity : MonoBehaviour
{
    ...
    public Action<Profile, string> onMessage = (profile,str) => { Debug.Log(str); };
    public Action<Profile, string, DonationExtras> onDonation = (profile, str, extra) => { Debug.Log(extra.payAmount); };

    // Start is called before the first frame update
    void Start()
    {
        StartListening("f00f6d46ecc6d735b96ecf376b9e5212");
    }
